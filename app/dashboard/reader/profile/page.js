...
export default function ReaderProfilePage() {
  ...
  const [stats, setStats] = useState({ booksRead: 0, purchased: 0, bookmarks: 0, lastActive: "2 hours ago" });
    ...
    <div className="flex bg-navy min-h-screen">
      ...
      <main className="flex-1 pt-20 px-8 pb-10">
        ...
        <div className="bg-navy-light border border-gold/10 rounded-2xl p-6 mb-6">
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <span className="px-2.5 py-1 bg-gold/10 border border-gold/20 rounded-full text-xs text-gold font-medium">👤 Reader</span>
            ...
            <div className="flex gap-2 flex-wrap">
              <button onClick={() => router.push("/dashboard/reader/purchased")} className="px-3 py-2 bg-navy border border-gold/20 hover:border-gold/40 text-gray-300 rounded-xl text-xs font-medium transition-all">📖 My Ebooks</button>
              <button onClick={() => router.push("/dashboard/reader/bookmarks")} className="px-3 py-2 bg-navy border border-gold/20 hover:border-gold/40 text-gray-300 rounded-xl text-xs font-medium transition-all">❤️ Bookmarks</button>
              {editMode
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Quick Links */}
          <div className="space-y-3">
            <div onClick={() => router.push("/dashboard/reader/purchased")} className="bg-navy-light border border-gold/10 hover:border-gold/30 rounded-2xl p-5 cursor-pointer transition-all">
            ...
            <div onClick={() => router.push("/dashboard/reader/bookmarks")} className="bg-purple-600 hover:bg-purple-700 rounded-2xl p-5 cursor-pointer transition-all">
              <div className="flex items-center justify-between">
